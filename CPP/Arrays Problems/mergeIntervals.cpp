...
/* 
Time Complexity -> O(nlogn)+O(n*n)  nlogn=sorting array  n*n=checking to the right for each index which is a nested loop.
Space Complexity -> O(n) -> we are using different data structure
*/
/*
